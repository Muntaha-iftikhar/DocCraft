...
<head>
    ...
    <title>Generate Cover Letter | DocCraft PRO</title>
    <style>
...
<body>
    ...
    <div class="cover-letter-container animate-fade">
        <div class="form-header">
            <h2>Cover Letter Generator</h2>
            <p>Fill in your details to create a professional cover letter</p>
        </div>
        
        <form action="{{ route('cover.generate') }}" method="POST" class="form-content">
            ...
            <div class="form-group">
                ...
                <input type="text" name="job_title" class="form-control" required placeholder="Software Engineer">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="industry" class="form-control" required placeholder="Technology">
            </div>
            
            <div class="form-group">
                <label class="form-label">Profession</label>
                <input type="text" name="profession" class="form-control" required placeholder="Software Development">
            </div>
            
            <div class="form-group full-width">
                <label class="form-label">Experience Summary (optional)</label>
                <textarea name="experience" rows="3" class="form-control" placeholder="Briefly describe your relevant experience..."></textarea>
            </div>
            
            <div class="form-group full-width">
                <label class="form-label">Additional Notes (optional)</label>
                <textarea name="notes" rows="3" class="form-control" placeholder="Any specific points you'd like to include..."></textarea>
            </div>
            
            <button type="submit" class="submit-btn">
                <i class="fas fa-magic submit-icon"></i> Generate Cover Letter
            </button>
        </form>
    </div>
